...
package io.lakestream.ursa.kafka.serde.protobuf;
...
import io.lakestream.ursa.kafka.serde.protobuf.test.CustomOptions.CustomMessageOptions;
import io.lakestream.ursa.kafka.serde.protobuf.test.CustomOptions2;
import io.lakestream.ursa.kafka.serde.protobuf.test.DecimalValueOuterClass.DecimalValue;
import io.lakestream.ursa.kafka.serde.protobuf.test.DecimalValuePb2OuterClass.DecimalValuePb2;
import io.lakestream.ursa.kafka.serde.protobuf.test.DependencyTestProto.DependencyMessage;
import io.lakestream.ursa.kafka.serde.protobuf.test.EnumReferenceOuter.EnumReference;
import io.lakestream.ursa.kafka.serde.protobuf.test.EnumRootOuter.EnumRoot;
...
import io.lakestream.ursa.kafka.serde.protobuf.test.Ranges;
import io.lakestream.ursa.kafka.serde.protobuf.test.TestMessageOptionalProtos;
import io.lakestream.ursa.kafka.serde.protobuf.test.TestMessageProtos.TestMessage;
import io.lakestream.ursa.kafka.serde.protobuf.test.TestMessageProtos.TestMessage2;
...
public class KafkaProtobufSerializerTest {
    ...
    public KafkaProtobufSerializerTest() {
        ...
        // TODO: testInner breaks if NORMALIZE_SCHEMAS is true
        // This happens where are `map` fields like in the NestedTestProto example
        serializerConfig.put(KafkaProtobufSerializerConfig.NORMALIZE_SCHEMAS, false);
    ...
    public void testKafkaProtobufSerializer() {
        ...
        // specific -> derived
        // TODO: java_outer_classname support missing or broken in KSN's ProtobufSchema class
        //bytes = protobufSerializer.serialize(topic, HELLO_WORLD_MESSAGE);
    ...
    public void testOptional() {
        String schemaString = "syntax = \"proto3\";\n"
                + "\n"
                + "package io.lakestream.ursa.kafka.serde.protobuf.test;\n"
                + "\n"
                + "option java_package = \"io.lakestream.ursa.kafka.serde.protobuf.test\";\n"
    ...
    @Disabled("TODO: CustomOptions aren't supported currently. ")
    @Test
    public void testCustomOptions() throws Exception {
        String expected = "syntax = \"proto3\";\n"
                ...
                + "\n"
                + "option (io.lakestream.ursa.kafka.serde.protobuf.test.file_custom) = \"test\";\n"
                + "option (io.lakestream.ursa.kafka.serde.protobuf.test.file_custom2) = \"hello\";\n"
                + "option (io.lakestream.ursa.kafka.serde.protobuf.test.file_custom2) = \"world\";\n"
                + "option java_package = \"io.lakestream.ursa.kafka.serde.protobuf.test\";\n"
                + "\n"
                ...
                + "    doc: \"message\"\n"
                + "  };\n"
                + "  option (io.lakestream.ursa.kafka.serde.protobuf.test.message_custom) = true;\n"
                + "  option (io.lakestream.ursa.kafka.serde.protobuf.test.message_custom2) = true;\n"
                + "  option (io.lakestream.ursa.kafka.serde.protobuf.test.message_custom2) = false;\n"
                + "\n"
                + "  string test_string = 1 [\n"
                + "    (io.lakestream.ursa.kafka.serde.protobuf.test.field_custom) = 123,\n"
                + "    (io.lakestream.ursa.kafka.serde.protobuf.test.field_custom2) = 456,\n"
                + "    (io.lakestream.ursa.kafka.serde.protobuf.test.field_custom2) = 789\n"
                + "  ];\n"
                ...
                + "    doc: \"enum\"\n"
                + "  };\n"
                + "  option (io.lakestream.ursa.kafka.serde.protobuf.test.enum_custom) = {\n"
                + "    d: 456,\n"
                + "    doc: \"hi\",\n"
                + "    f: 123,\n"
                + "    id: 1\n"
                + "  };\n"
                + "  option (io.lakestream.ursa.kafka.serde.protobuf.test.enum_custom2) = {\n"
                + "    doc: \"hi\",\n"
                + "    id: 2,\n"
                + "    list: [\n"
                + "      4,\n"
                ...
                + "    }\n"
                + "  };\n"
                + "  CUSTOM0 = 0 [(io.lakestream.ursa.kafka.serde.protobuf.test.enum_value_custom) = ENUM1];\n"
                + "  CUSTOM1 = 1 [\n"
                + "    (io.lakestream.ursa.kafka.serde.protobuf.test.enum_value_custom2) = ENUM1,\n"
                + "    (io.lakestream.ursa.kafka.serde.protobuf.test.enum_value_custom2) = ENUM2\n"
                + "  ];\n"
                ...
                + "  .io.lakestream.ursa.kafka.serde.protobuf.test.MyMessage enum_custom = 1111;\n"
                + "  repeated .io.lakestream.ursa.kafka.serde.protobuf.test.MyMessage enum_custom2 = 1112;\n"
                + "}\n"
                + "extend .google.protobuf.EnumValueOptions {\n"
                + "  .io.lakestream.ursa.kafka.serde.protobuf.test.MyEnum enum_value_custom = 1111;\n"
                + "  repeated .io.lakestream.ursa.kafka.serde.protobuf.test.MyEnum enum_value_custom2 = 1112;\n"
                + "}\n";
    ...
    public void testCustomOptions2() throws Exception {
        String expected = "package io.lakestream.ursa.kafka.serde.protobuf.test;\n"
                + "\n"
                + "import \"google/protobuf/descriptor.proto\";\n"
                + "\n"
                + "option java_package = \"io.lakestream.ursa.kafka.serde.protobuf.test\";\n"
                ...
                + "  repeated .io.lakestream.ursa.kafka.serde.protobuf.test.FooBar nested = 3;\n"
                + "\n"
                ...
                + "\n"
                + "  message More {\n"
                + "    option (io.lakestream.ursa.kafka.serde.protobuf.test.my_message_option) = {\n"
                + "      [io.lakestream.ursa.kafka.serde.protobuf.test.FooBar.More.more_string]: \"foobar\",\n"
                + "      [io.lakestream.ursa.kafka.serde.protobuf.test.rep]: [\n"
                + "        FOO,\n"
                + "        BAR\n"
                + "      ]\n"
                + "    };\n"
                ...
                + "  \n"
                + "    extend .io.lakestream.ursa.kafka.serde.protobuf.test.FooBar {\n"
                + "      optional string more_string = 150;\n"
                + "    }\n"
                + "  }\n"
                + "  message More2 {\n"
                + "    option (io.lakestream.ursa.kafka.serde.protobuf.test.my_message_option) = {\n"
                + "      [io.lakestream.ursa.kafka.serde.protobuf.test.FooBar.More2.more2_string]: \"foobar\",\n"
                + "      foo: 123\n"
                + "    };\n"
                + "  \n"
                + "    repeated int32 serial = 1;\n"
                ...
                + "  }\n"
                + "  enum FooBarBazEnum {\n"
                + "    option (io.lakestream.ursa.kafka.serde.protobuf.test.FooBar.foobar_string) = \"foobar\";\n"
                + "    FOO = 1;\n"
                + "    BAR = 2;\n"
                + "    BAZ = 3;\n"
                + "  }\n"
                ...
                + "\n"
                + "extend .google.protobuf.MessageOptions {\n"
                + "  optional .io.lakestream.ursa.kafka.serde.protobuf.test.FooBar my_message_option = 50099;\n"
                + "}\n"
                + "extend .io.lakestream.ursa.kafka.serde.protobuf.test.FooBar {\n"
                + "  optional .io.lakestream.ursa.kafka.serde.protobuf.test.FooBar.FooBarBazEnum ext = 101;\n"
                + "  repeated .io.lakestream.ursa.kafka.serde.protobuf.test.FooBar.FooBarBazEnum rep = 102;\n"
                + "}\n";
        ...
        expected = "package io.lakestream.ursa.kafka.serde.protobuf.test;\n"
                + "\n"
                + "import \"google/protobuf/descriptor.proto\";\n"
                + "\n"
                + "option java_package = \"io.lakestream.ursa.kafka.serde.protobuf.test\";\n"
    ...
    public void testKafkaProtobufDeserializerWithPreRegisteredUseLatestRecordNameStrategy()
        ...
        schemaRegistry.register("io.lakestream.ursa.kafka.serde.protobuf.test.TestMessage", schema);
    ...
    public void testDependencyPreregisterRefWithNegativeOne() throws Exception {
        ...
        schema = schemaRegistry.parseSchema(ProtobufSchema.TYPE, schema.canonicalString(), ImmutableList.of(refCopy))
                .get();
